    ...
    >
      ...
      <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
        ...
        <Link to={GITHUB_LINK} target="_blank" rel="noopener noreferrer">
          ...
          <img
            className="h-7 cursor-pointer md:h-7 md:pl-2 transition hover:rotate-[360deg] hover:ease-in hover:duration-500  hover:scale-150 cursor-pointer hover:text-gray-700"
            src={bbb}
          ></img>
              
            <span className="invisible group-hover:visible opacity-80 text-xs bg-gray-600 text-white block p-2 rounded-md absolute whitespace-nowrap -right-1/2 -bottom-9">
              Created by wisdom nkuna © 2023
            </span>
          </div>
        </Link>
      </div>
